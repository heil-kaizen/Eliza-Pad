        ...
        <div className="p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-[#FF9A1F]/5 border border-[#FF9A1F]/10">
              <h4 className="text-xs font-orbitron font-bold text-[#FF9A1F] mb-4 uppercase tracking-widest">Eliza Intelligence Report</h4>
...
const LatestLaunches: React.FC<LatestLaunchesProps> = ({ launches, title = "Latest Eliza-Verified Launches" }) => {
