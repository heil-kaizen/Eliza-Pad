        ...
        <div className="space-y-16 text-[#9BA1A6] font-inter leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-orbitron font-bold text-[#F8F9FA] mb-4 flex items-center gap-3">
              <span className="text-[#FF9A1F]">01</span> The Eliza AI Curation Framework
            </h2>
            <div className="pl-8 border-l border-white/10 space-y-4">
              <p>
                The Eliza AI engine serves as the foundational security and verification layer of the ElizaPad ecosystem. Unlike traditional permissionless launchpads, ElizaPad implements an autonomous auditing process powered by the ElizaOS framework.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong className="text-white/80">Social Graph Integration:</strong> Eliza agents monitor X and Telegram to distinguish between organic community growth and artificial bot activity. This ensures that only projects with genuine human engagement reach the upper tiers of the launchpad.</li>
          ...
          <section>
            ...
            <div className="pl-8 border-l border-white/10 space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                <li><strong className="text-white/80">The Incubation Phase:</strong> Upon creation, tokens are placed in a monitored sandbox. During this period, ElizaPad observes the initial buy and sell pressure to verify that no single entity is attempting to corner the supply through sybil attacks.</li>
          ...
          <section>
            ...
            <div className="pl-8 border-l border-white/10 space-y-4">
              <p>
                To maintain a high-quality ecosystem, ElizaPad enforces specific standards for all developers wishing to launch on the platform.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong className="text-white/80">Anti-Bot and Fair Launch Protocols:</strong> ElizaPad utilizes a combination of wallet age verification and rate-limiting to prevent sniper bots from dominating the initial supply. This ensures a fairer distribution for community participants.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="pl-8 border-l border-white/10 space-y-4">
              <p>
                The ElizaPad demo is built using a modern frontend stack designed to simulate a full-scale blockchain environment.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong className="text-white/80">ElizaOS Logic:</strong> The logic for autonomous monitoring and community sentiment is designed around the ElizaOS agent framework, allowing for future expansion into real-time on-chain logic.</li>
              </ul>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="pl-8 border-l border-white/10 space-y-4">
              <p>
                The ElizaPad architecture prioritizes user safety through a multi-layered defensive strategy. Beyond simple contract audits, the platform implements behavioral analysis to detect sophisticated malicious patterns.
              </p>
              <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-orbitron font-bold text-[#F8F9FA] mb-4 flex items-center gap-3">
              <span className="text-[#4FD1FF]">06</span> The ElizaPad Bonding Curve Model
            </h2>
            <div className="pl-8 border-l border-white/10 space-y-4">
              <p>
                The economic foundation of ElizaPad relies on a mathematical bonding curve designed to incentivize early participation while maintaining long-term price stability.
              </p>
              <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            ...
            <div className="pl-8 border-l border-white/10 space-y-4">
              <p>
                While ElizaPad is driven by AI, the ultimate direction of the protocol is steered by its community through decentralized governance.
              </p>
              <ul className="list-disc pl-5 space-y-2">
                <li><strong className="text-white/80">The Spotlight Voting System:</strong> Users who hold the native ElizaPad utility token can participate in the "Spotlight" selection process. This allows the community to vote on which AI-verified projects receive premium placement on the homepage.</li>
                <li><strong className="text-white/80">Decentralized Dispute Resolution:</strong> In the event of a project dispute, the ElizaPad DAO (Decentralized Autonomous Organization) can initiate a review. AI agents provide the data and forensics, but the final decision to delist or flag a project rests with the community voters.</li>
          ...
          <section>
            ...
            <div className="pl-8 border-l border-white/10 space-y-4">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong className="text-white/80">Phase 2: ElizaOS Agent Deployment:</strong> Integration of the ElizaOS framework to handle live social media monitoring and autonomous contract auditing on the Solana Devnet.</li>
