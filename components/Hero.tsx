...
const Hero: React.FC<HeroProps> = () => {
  ...
  // Using the user's official ElizaPad image URL
  const ELIZA_MASCOT_URL = "https://raw.githubusercontent.com/heil-kaizen/eliza-pad/main/ElizaPad.png";
  ...
  const handleImageError = () => {
    if (imgSrc === ELIZA_MASCOT_URL) {
      // Primary fallback to a reliable AI mascot image
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-[#9BA1A6] max-w-lg mb-12 font-medium leading-relaxed font-inter opacity-0 animate-[fadeIn_1s_ease-out_1s_forwards]">
              The world's first AI-curated launchpad. Privacy-focused, community-driven, and powered by <span className="text-white font-bold border-b border-[#FF9A1F]/30">Eliza AI</span>.
            </p>
          ...
          <div className="relative flex justify-center items-center">
            ...
            <div className="relative w-[400px] h-[400px] md:w-[500px] md:h-[500px] rounded-full border-2 border-[#FF9A1F]/20 shadow-[0_0_80px_rgba(255,154,31,0.15)] overflow-hidden group bg-[#0E0F13]">
              ...
              {/* Character Image (Cyberpunk Eliza) */}
              <img 
                src={imgSrc} 
                alt="Eliza Mascot" 
              ...
              {isError && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center p-8 bg-[#0E0F13]">
                  ...
                  <button 
                    onClick={() => {setIsLoading(true); setImgSrc(ELIZA_MASCOT_URL + "?t=" + Date.now()); setIsError(false);}}
